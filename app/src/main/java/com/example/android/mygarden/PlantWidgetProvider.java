...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews rv;
        if (width < 300) {
            rv = getSinglePlantRemoveView(context, imgRes, plantId, showWater);
        } else {
            rv = getGardenGridRemoveView(context);
        }
    ...
    private static RemoteViews getSinglePlantRemoveView(Context context, int imgRes, long plantId, boolean showWater) {
     ...
     * @return
     */
    private  static RemoteViews getGardenGridRemoveView(Context context) {
